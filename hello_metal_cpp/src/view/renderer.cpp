...
void Renderer::buildMeshes() {
    ...
    svgMesh = MeshFactory::buildSVG(device, "/Users/rashmig/Desktop/CODE_PROJECT/line/square.svg"
    );
}
...
void Renderer::setZoomFactor(float zoom) {
    zoomFactor = zoom;
}

void Renderer::setPanOffset(float x, float y) {
    panX = x;
    panY = y;
}
